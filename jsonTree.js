 ...
 *
 * Modified by superDuperCyberTechno for rubbish (https://github.com/superDuperCyberTechno/rubbish)
 */
    ...
    function _NodeComplex(label, val, isLast) {
        ...
        var self = this,
            ...
            template = function(label, sym) {
                var comma = (!isLast) ? ',' : ''
                var str = '<div class="jsontree_value-wrapper"><div class="jsontree_value jsontree_value_' + self.type + '"><b>' + sym[0] + '</b><span class="jsontree_show-more padded">&hellip;</span><ul class="jsontree_child-nodes"></ul><b>' + sym[1] + '</b></div>' + comma + '</div>';
